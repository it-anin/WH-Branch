...
- **append ไม่ทับ**: รายการถูก "เพิ่มต่อท้าย" catalog เดิม (+ stamp `item.branch` จากชื่อไฟล์, **ไม่แตะ `_meta`**) → จำนวนรายการของพนักงานคนอื่นไม่เปลี่ยน → จอไม่ remount **ของที่สแกนค้างรอด แทรกกลางวันได้**; เฉพาะคนที่ tick 📌เบิกด่วน จอรีเซ็ต (confirm เตือนให้ปิดลังค้างก่อน)
